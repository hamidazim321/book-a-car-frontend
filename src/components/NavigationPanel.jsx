...
export default function NavigationPanel() {
  ...
  return (
    <div>
      <button onClick={handleSidebar} aria-controls="default-sidebar" type="button" className="inline-flex items-center p-2 mt-2 ms-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200">
      ...
      <aside id="default-sidebar" className={`p-2 bg-gray-50 fixed top-0 left-0 z-40 w-64 h-screen transition-transform sm:translate-x-0 ${openSidebar ? '' : '-translate-x-full'}`} aria-label="Sidebar">
        <div>
